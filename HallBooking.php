    ...
    <div class="collapse navbar-collapse" id="navbarHover">
        <ul class="navbar-nav">
            ...
            <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="HallBooking.php">Hall Booking<span class="sr-only">(current)</span></a></li> 
...
<form method="post" action="HallBookingphp.php">
     
<table cellpadding="10px" align="center">

<tr>
<td colspan="2">
<input type="text" placeholder="                 WELLCOME FOR HALL BOOKING"  readonly style="background-color:white; color:black; width:105%" /> 
</td>
</tr>
...
<td>
<select style="width:110%" id="htitle" name="htitle">
...
<td>
<input type="text" placeholder="Enter Your Full Name" id="hname" name="hname" required   style="width:110%" pattern="[A-Za-z]{0-30}" maxlength="20" />
</td>
</tr>
...
<td>
<input type="email" placeholder="Your Email Address" id="hemail" name="hemail" required style="width:110%" />
</td>
</tr>

<tr>
<td><input type="text" placeholder="Your Phone Number" readonly style="background-color:#6CC; color:#000" />
</td> <td><input type="tel" placeholder="Enter Your PhoneNo" id="hphone" name="hphone" required  style="width:110%" pattern="^\d{10}$" maxlength="11" />
</td>
</tr>
...
<td>
<select  style="width:110%" id="hcountry" name="hcountry">
<option hidden="" value="0">-Select-</option>
...
<td>
<select  style="width:110%" id="hcity" name="hcity">
<option hidden="" value="0">-Select-</option>
...
<tr>
<td>
<input type="text" placeholder="Guest" readonly style="background-color:#6CC; color:#000" />     
</td> 
<td> 
<input type="tel" placeholder="Guest" required style="width:110%" id="hguest" name="hguest" />
</td>
</tr>
...
<td><input type="text" required id="date11" name="date11"  style="width:110%"/>
</td>
</tr>
...
<td>
<input type="text" required id="date22" name="date22" style="width:110%" />
</td>
</tr>
...
<td>
<textarea  style="width:110%" id="haddress" name="haddress" pattern="[A-Za-z]{0-30}" maxlength="100"></textarea>
</td>
</tr>

<tr>
<td colspan="2" ><input type="submit" value="submit" name="button"  style="width:105%" /></td>
</tr>
